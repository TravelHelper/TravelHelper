...
- (instancetype)initWithInformationModel:(InformationModel *)infoModel
{
    ...
    if (self) {
        ...
        CGFloat minReceiveInfoLableX = kScreenWith*0.3;
        ...
        self.receiveInfoLableFrame = CGRectMake(minReceiveInfoLableX, kSubViewVerticalHeight,kScreenWith-2*kSubViewHorizontalMargin-minReceiveInfoLableX, infoSize.height);
    }
    return self;
}
@end
