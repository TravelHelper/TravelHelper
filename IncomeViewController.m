...
- (void)viewDidLoad {
    ...
    //当天收入
    UILabel *todayIncomeLable = [[UILabel alloc]initWithFrame:CGRectMake(0, 64, kScreenWindth/2-1, 0.14*kScreenHeight)];
    todayIncomeLable.backgroundColor =[UIColor colorWithRed:239.0/255 green:239.0/255 blue:239.0/255 alpha:1];
    ...
    [self.view addSubview:todayIncomeLable];
