...
-(void)sendBtnIClick{
    ...
    NSString *reward_id = [NSString stringOfUUID];
    ...
    
    {
        ...
        [WebAgent sendRewardRewardID:reward_id rewardTitle:self.titleTextView.text rewardText:self.contentTextView.text rewardUrl:self.imageName rewardMoney:self.returnMoney.text rewardLanguage:self.returnLanguage.text rewardtag:self.tag success:^(id responseObject) {
